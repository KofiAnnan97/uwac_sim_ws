...
SET REMOTE_IP_1=192.168.1.60

SET REMOTE_FOLDER_2=/home/pi/catkin_ws/src/seatrac_pkg/
SET REMOTE_USER_2=pi
SET REMOTE_IP_2=192.168.1.61

SET REMOTE_FOLDER_3=/home/pi/catkin_ws/src/seatrac_pkg/
SET REMOTE_USER_3=pi
SET REMOTE_IP_3=192.168.1.62
...
ECHO ===============================
ECHO ===============================
ECHO Remote Path: %REMOTE_FOLDER_3%
ECHO Remote User: %REMOTE_USER_3%
ECHO Remote IP  : %REMOTE_IP_3%
ECHO ===============================
...
rem ECHO 3. Synchronizing files in %REMOTE_IP_2%...
rem rsync -avz --progress %LOCAL_FOLDER% %REMOTE_USER_2%@%REMOTE_IP_2%:%REMOTE_FOLDER_2%
rem IF ERRORLEVEL 1 GOTO :ERROR

rem ECHO 4. Synchronizing files in %REMOTE_IP_3%...
rem rsync -avz --progress %LOCAL_FOLDER% %REMOTE_USER_3%@%REMOTE_IP_3%:%REMOTE_FOLDER_3%
rem IF ERRORLEVEL 1 GOTO :ERROR
