...
def generate_test_description():
    ...
    world_file_name = os.path.join(get_package_share_directory('simple_3d_move_plugin'),
                                   'test', 'test.world')
    urdf_file_name = os.path.join(get_package_share_directory('simple_3d_move_plugin'),
                                  'test', 'test.urdf')
...
class TestMovePlugin(unittest.TestCase):
